# The following is automatically generated by rebuild_numba_support.py
...
tally = into_dtype([
    ...
    ('bin_offset', int64),
    ('bin_length', int64),
    ('bin_mean_offset', int64),
    ('bin_mean_length', int64),
    ('bin_sum_squared_deviations_offset', int64),
    ('bin_sum_squared_deviations_length', int64),
...
# ======================================================================================
# Problem-dependent Numba type factories
# ======================================================================================

def make_bank_type(particle_capacity: int):
    return into_dtype([
        ('size', int64, (1,)),
        ('tag', 'U32'),
        ('particle_data', particle_data, (particle_capacity,)),
    ])

def make_simulation_type(N: dict):
    return into_dtype([
        ('data', data, (N['data'])),
        ('N_data', int64),
        ...
        ('technique', technique),
        ('gpu_meta', gpu_meta),
        ('bank_future', make_bank_type(N['future_particle'])),
        ('bank_source', make_bank_type(N['source_particle'])),
        ...
        ('idx_census', int64),
        ('idx_batch', int64),
        ('N_tally_sample', int64),
        ('history_based_statistics', bool_),
        ('k_eff', float64),
